...
exp_name="exp_moco_res50_imagenet"

# pretrain encoder
python ./pretrain.py -a resnet50 --algo moco --batch-size 256 --lr 0.03 --epochs 200 --cos --dataset imagenet --data-path $data_path --mlp --moco-t 0.2 --aug-plus --exp-name $exp_name --multiprocessing-distributed --dist-url tcp://localhost:10001 --gpu 0 1 2 3 4 5 6 7 --save-freq 10
