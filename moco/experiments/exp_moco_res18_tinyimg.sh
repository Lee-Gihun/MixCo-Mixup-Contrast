...
# pretrain encoder
python ./pretrain.py -a resnet18 --algo moco --batch-size 128 --lr 0.015 --epochs 100 --cos --dataset tiny-imagenet --data-path $data_path --mlp --moco-t 0.2 --aug-plus --exp-name $exp_name --multiprocessing-distributed --dist-url tcp://localhost:10001 --gpu 0 1
