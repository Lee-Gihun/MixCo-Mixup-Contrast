...
# pretrain encoder
python ./pretrain.py -a resnet18 --batch-size 128 --lr 0.15 --epochs 100 --dataset tiny-imagenet --data-path $data_path --temperature 0.5 --exp-name $exp_name --cos --multiprocessing-distributed --dist-url tcp://localhost:10001 --gpu 0 1 --out-dim 128
